  ...
  try {
    ...
    const { data: eventType, error: createError } = await supabase
      ...
      .insert({
        ...
        guest_description_template: validatedData.guestDescriptionTemplate || '{meet_link}',
        ...
        buffer_minutes: validatedData.bufferMinutes ?? 0,
        days_ahead: validatedData.daysAhead ?? 14,
        min_notice_minutes: validatedData.minNoticeMinutes ?? 60,
        slug,
