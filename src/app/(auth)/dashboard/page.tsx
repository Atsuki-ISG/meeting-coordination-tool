                      ...
                      <div key={eventType.id} className="p-5 group hover:bg-slate-50/50 transition">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className={`font-semibold ${eventType.is_active ? 'text-slate-900 group-hover:text-brand-500' : 'text-slate-400'} transition-colors truncate`}>
                              {eventType.title}
                            </p>
                            ...
                            <p className={`text-sm ${eventType.is_active ? 'text-slate-500' : 'text-slate-400'} mt-0.5`}>
