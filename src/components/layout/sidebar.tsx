  ...
  const NavContent = () => (
    <>
      ...
      <div className="p-6 md:p-8">
        <Link href="/team" prefetch={false} className="flex items-center gap-3 hover:opacity-80 transition">
      ...
      {/* Navigation */}
      <nav className="flex-1 px-2 space-y-1 mt-4 overflow-y-auto pb-4">
        {navItems.map((item) => {
